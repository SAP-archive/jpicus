...
public class WrapInputStreamMethodVisitor extends InsertAroundMethodVisitor {

	public WrapInputStreamMethodVisitor(MethodVisitor next) {
		super(next);
	}
	...
	protected void insertAfter() {
		...
		// InputStream wrapInputStream(InputStream toBeWrapped, Object handle)
		mv.visitMethodInsn(INVOKESTATIC, Agent.AGENT_CLASS, "wrapInputStream", "(Ljava/io/InputStream;Ljava/lang/Object;)Ljava/io/InputStream;");
